...
class TestHomePage:
    ...
    trending_test_tile = (By.XPATH, "//*[contains(text(),'Trending Tests for Your Exam')]/parent::div/div[2]/div[2]/div/div[1]/div/div/div")
    take_full_test =(By.XPATH, "//*[contains(text(),'Take Full Tests')]/parent::div/div[2]/div[2]/div/div[1]/div/div/div")
    take_chapter_test = (By.XPATH, "//*[contains(text(),'Take Chapter Tests')]/parent::div/div[2]/div[2]/div/div[1]/div/div/div")
    ...
    fib_2_field = (By.XPATH, "//body/div[@id='app']/main[1]/div[1]/div[1]/div[4]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/span[2]/input[1]")
    ...
    step1_select_Chapters = (By.XPATH, "//div[contains(@class, 'test-subjects-wrapper--subject-selection')]/div/div/div[3]/div/div")
    ...
    def quick_5_mins_cyot(self):
        ...
        for i in range (1, len(chapter_count)+1):
            self.driver.find_element(By.XPATH, "//div[contains(@class,'test-chapters-wrapper--subjects hide')]/div["+str(i)+"]").click()
